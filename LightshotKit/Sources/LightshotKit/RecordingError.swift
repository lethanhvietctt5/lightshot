...
/// outcome. `permissionDenied` carries *which* permission is missing — Screen Recording,
/// microphone, camera or input monitoring — because the recovery message and the System Settings
/// pane differ per kind (story 41).
///
